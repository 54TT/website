  ...
  return (
    <>
      <div className={styles.mobliceSocialBox}>
        <div
          className={`min-h-screen ${changeAllTheme(
            "darknessTwo",
            "brightTwo"
          )} ${styles.mobliceMinH_Scree}`}
          style={{ backgroundColor: "rgb(253,213,62)", borderRadius: "10px", height: winHeight,minHeight: winHeight}}
        >
          <main className={styles.mobliceMain} style={{ display: "flex" }}>
            <div>
